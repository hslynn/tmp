...
def get_exact_var_list(func_space):
    g00_exp = Expression("-1", degree=10)
    g01_exp = Expression("0", degree=10)
    g11_exp = Expression("1", degree=10)
    
    Pi00_exp = Expression("0", degree=10)
    Pi01_exp = Expression("0", degree=10)
    Pi11_exp = Expression("0", degree=10)
    
    Phi00_exp = Expression("0", degree=10)
    Phi01_exp = Expression("0", degree=10)
    Phi11_exp = Expression("0", degree=10)
...
def get_H_list(func_space):
    H0_exp = Expression("0", degree=10)
    H1_exp = Expression("2/x[0]", degree=10)
...
def get_deriH_list(func_space):
    ...
    deriH10_exp = Expression("0", degree=10)
    deriH11_exp = Expression("-2/pow(x[0], 2)", degree=10)

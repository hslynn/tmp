...
def get_Hhat_forms(var_list, deri_list, auxi_list, local_max_shift):
    g00, g01, g11 = var_list[:3]
    Pi00, Pi01, Pi11 = var_list[3:6]
    Phi00, Phi01, Phi11 = var_list[6:9]
